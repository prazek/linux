...
again:
	...
	do {
		...
		if (pte_present(ptent)) {
			...
			} else if (vma->vm_flags & VM_READ && pte_write(ptent) && pte_young(ptent) &&
                    access_ok(VERIFY_READ, addr, PAGE_SIZE) && !should_not_scan()) {
		...
		struct zap_details *details)
{
	...
	/*if (vma_is_anonymous(vma))
		soczewka_check_released_mem(start, end - start);*/
